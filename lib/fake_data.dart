...
List<Category> fakeCategory = [
  ...
  Category(id: 4, content: 'Rau Củ', color: Colors.blueAccent),
  Category(id: 5, content: 'Spagetti', color: Colors.yellowAccent),
  Category(id: 6, content: 'Su Hào', color: Colors.indigo),
  Category(id: 7, content: 'Khoai Tây Chiên', color: Colors.amberAccent),
  Category(id: 8, content: 'Sò Hấp', color: Colors.pinkAccent),
  Category(id: 9, content: 'Khoai Tây Chiên', color: Colors.amberAccent),
  Category(id: 10, content: 'Sò Hấp', color: Colors.pinkAccent),
  Category(id: 11, content: 'Khoai Tây Chiên', color: Colors.amberAccent),
  Category(id: 12, content: 'Sò Hấp', color: Colors.pinkAccent),
];
var FAKE_FOODS = [
